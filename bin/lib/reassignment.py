...
def Reassign(align_list,error_rate=0.05,ratio=0.05,threads=96,AS_threshold=0,level='species'):
...
if __name__ == '__main__': 
    ...
    Reassign(align_list,error_rate=FLAGS.error_rate,ratio=FLAGS.ratio,threads=FLAGS.threads,AS_threshold=FLAGS.AS_threshold,level=FLAGS.level)
